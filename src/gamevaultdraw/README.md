...
Windows release of Disney's Aladdin included in *Disney's Classic Video
Games*.
...
Win9x-era uninitialised-`RECT` behaviour observed in Aladdin without hardcoding
...
The Aladdin test launcher also uses a temporary `SUBST` drive because the game
...
property pages. Their ten 1996 edit-control callbacks truncate the pointer in
